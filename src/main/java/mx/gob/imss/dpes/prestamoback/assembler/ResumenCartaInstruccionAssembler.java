 ...
 */
@Provider
public class ResumenCartaInstruccionAssembler
 extends BaseAssembler<ReporteResumenSimulacion, Documento, Long, Long>{
  ...
  public Documento assemble(ReporteResumenSimulacion source) {
    ...
    resumen.setCorreoElectronico(source.getPromotor().getEntidadFinanciera().getCorreoElectronico());
    ...
    resumen.setNumEmpleado( source.getPromotor().getNumEmpleado() );
    resumen.setNombreP(source.getPromotor().getNombre());
    resumen.setPrimerApellido(source.getPromotor().getPrimerApellido());
    resumen.setSegundoApellido(source.getPromotor().getSegundoApellido());
    resumen.setCurpPromotor(source.getPromotor().getCurp());
    resumen.setImporteARecibir(source.getPrestamo().getImporteARecibir().toString());
    //resumen.setOrigen(source.getSolicitud().getOrigenSolictud().getDescripcion());
