 ...
 */
@Provider
public class CalcularTblAmortizacionService extends BaseService {
    ...
    public LinkedList<AmortizacionPorDescuento> getAmortizacionTablaList(AmortizacionDatosBase amortizacionDatosBase)
        ...
        try {
            ...
            log.log(Level.SEVERE,
                "ERROR CalcularTblAmortizacionService.getAmortizacionTablaList = [" +
    ...
    public double getCapitalInsoluto(AmortizacionDatosBase amortizacionDatosBase, int numMensualidad) throws BusinessException {
        ...
        for (AmortizacionPorDescuento amortizacionPorDescuento : amortizacionTablaList) {
            if (amortizacionPorDescuento.getPeriodo() == numMensualidad &&
                    amortizacionPorDescuento.getSaldo() != null) {
                    saldo = MontoUtils.obtenerDouble(amortizacionPorDescuento.getSaldo());
            }
        }
